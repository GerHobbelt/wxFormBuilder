...
IntList::IntList(bool absolute_value, bool pair_value) : m_abs(absolute_value), m_pairs(pair_value)
{
}

IntList::IntList(const wxString& value, bool absolute_value, bool pair_value) : IntList(absolute_value, pair_value)
{
    SetList(value);
}
